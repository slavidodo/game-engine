...
public:
	...
	struct MaterialTypedValue {
		MaterialTypedValue(MaterialTypedValueType type, void* value, size_t size)
	...
	typedef std::unordered_map<std::string, MaterialTypedValue> TypedValuesMap;
	typedef TypedValuesMap::iterator TypedValuesMapIterator;
	typedef TypedValuesMap::const_iterator TypedValuesMapCIterator;
	...
	void SetFloatArray(std::string global, float* value, std::size_t size);
